  ...
  */
  ...
  verifyPassword(password, captchaCode) {
    return this.fetchMeetingInfo({
      ...
      .catch((error) => {
        Metrics.sendBehavioralMetric(
          BEHAVIORAL_METRICS.VERIFY_PASSWORD_FAILURE,
          {
            correlation_id: this.correlationId,
  ...
  refreshCaptcha() {
    ...
    return this.meetingRequest.refreshCaptcha({
      ...
      .then((response) => {
        Metrics.sendBehavioralMetric(
          BEHAVIORAL_METRICS.CAPTURE_CAPTCHA_SUCCESS,
          {
            correlation_id: this.correlationId
          }
        );
        ...
        Metrics.sendBehavioralMetric(
          BEHAVIORAL_METRICS.CAPTURE_CAPTCHA_FAILURE,
          {
            correlation_id: this.correlationId,
            reason: error.message,
            stack: error.stack
  ...
  setNetworkStatus(networkStatus) {
    if (networkStatus === NETWORK_STATUS.DISCONNECTED) {
      ...
      Metrics.sendBehavioralMetric(
        BEHAVIORAL_METRICS.NETWORK_DISCONNECTED,
        {
          correlation_id: this.correlationId
        }
      );
      ...
      Metrics.sendBehavioralMetric(
        BEHAVIORAL_METRICS.NETWORK_RECONNECTED,
        {
          correlation_id: this.correlationId
        }
      );
  ...
  invite(invitee, alertIfActive = true) {
    return this.members.addMember(invitee, alertIfActive)
      .then((res) => {
        Metrics.sendBehavioralMetric(
          BEHAVIORAL_METRICS.INVITE_MEMBERS_SUCCESS,
          {
            correlation_id: this.correlationId,
            locus_id: this.locusId
          }
      ...
      .catch((error) => {
        Metrics.sendBehavioralMetric(
          BEHAVIORAL_METRICS.INVITE_MEMBERS_FAILURE,
          {
            correlation_id: this.correlationId,
  ...
  muteAudio() {
    ...
    return logRequest(this.audio.handleClientRequest(this, true)
      .then(() => {
        ...
        Metrics.sendBehavioralMetric(
          BEHAVIORAL_METRICS.MUTE_AUDIO_SUCCESS,
          {
            correlation_id: this.correlationId,
            locus_id: this.locusUrl.split('/').pop()
          }
  ...
  unmuteAudio() {
    ...
    return logRequest(this.audio.handleClientRequest(this, false)
      .then(() => {
        ...
        Metrics.sendBehavioralMetric(
          BEHAVIORAL_METRICS.UNMUTE_AUDIO_SUCCESS,
          {
            correlation_id: this.correlationId,
            locus_id: this.locusUrl.split('/').pop()
          }
  ...
  muteVideo() {
    ...
    return logRequest(this.video.handleClientRequest(this, true)
      .then(() => {
        ...
        Metrics.sendBehavioralMetric(
          BEHAVIORAL_METRICS.MUTE_VIDEO_SUCCESS,
          {
            correlation_id: this.correlationId,
            locus_id: this.locusUrl.split('/').pop()
          }
  ...
  unmuteVideo() {
    ...
    return logRequest(this.video.handleClientRequest(this, false)
      .then(() => {
        ...
        Metrics.sendBehavioralMetric(
          BEHAVIORAL_METRICS.UNMUTE_VIDEO_SUCCESS,
          {
            correlation_id: this.correlationId,
            locus_id: this.locusUrl.split('/').pop()
          }
  ...
  reconnect(options) {
    ...
    return this.reconnectionManager
      ...
      .then(() => {
        ...
        Metrics.sendBehavioralMetric(
          BEHAVIORAL_METRICS.MEETING_RECONNECT_SUCCESS,
          {
            correlation_id: this.correlationId,
            locus_id: this.locusUrl.split('/').pop()
          }
  ...
  async receiveTranscription() {
    ...
    try {
      ...
      Metrics.sendBehavioralMetric(
        BEHAVIORAL_METRICS.RECEIVE_TRANSCRIPTION_SUCCESS,
        {
          correlation_id: this.correlationId
        }
      );
  ...
  dialInPstn() {
    ...
    return this.meetingRequest.dialIn({
      ...
      Metrics.sendBehavioralMetric(
        BEHAVIORAL_METRICS.ADD_DIAL_IN_SUCCESS,
        {
          correlation_id: this.correlationId,
  ...
  dialOutPstn(phoneNumber) {
    ...
    return this.meetingRequest.dialOut({
      ...
      Metrics.sendBehavioralMetric(
        BEHAVIORAL_METRICS.ADD_DIAL_OUT_SUCCESS,
        {
          correlation_id: this.correlationId,
