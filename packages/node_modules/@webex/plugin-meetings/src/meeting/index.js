...
export default class Meeting extends StatelessWebexPlugin {
  ...
  */
  ...
  setUpLocusInfoListeners() {
    ...
    this.setUpEmbeddedAppsListener();
  }
  ...
  setUpEmbeddedAppsListener() {
    this.locusInfo.on(LOCUSINFO.EVENTS.EMBEDDED_APP_UPDATED, (embeddedApp) => {
      console.log('Received EMBEDDED APP ', embeddedApp);
      Trigger.trigger(
        this,
        {
          file: 'meeting/index',
        ...
        EVENT_TRIGGERS.MEETING_EMBEDDED_APPS,
        {
          embeddedApp
        }
      );
