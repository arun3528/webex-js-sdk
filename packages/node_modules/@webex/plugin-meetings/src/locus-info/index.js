...
import EmbeddedAppsUtils from '../locus-info/EmbeddedAppUtils';
...
export default class LocusInfo extends EventsScope {
  ...
  updateEmbeddedApps(embeddedApps) {
    if (embeddedApps && (!isEqual(this.embeddedApps, embeddedApps))) {
      const parsedEmbeddedApps = EmbeddedAppsUtils.getEmbeddedApps(this.parsedLocus.embeddedApps, embeddedApps);


      if (parsedEmbeddedApps.updates.slidoChanged) {
        this.emitScoped(
          {
            file: 'locus-info',
            function: 'updateMeetingInfo'
          },
          LOCUSINFO.EVENTS.EMBEDDED_APP_UPDATED,
          {slidoApp: parsedEmbeddedApps.current.slidoApp}
        );
      }

      this.embeddedApps = embeddedApps;
      this.parsedLocus.embeddedApps = parsedEmbeddedApps.current;

      this.updateMeeting(parsedEmbeddedApps.current);
    }
  }
