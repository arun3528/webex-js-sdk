...
// Local Dependencies
import {WDM_METRICS} from '../../common/src/metrics';
    ...
    return this.canRegister()
      .then(() => {
        ...
        return this.request({
          ...
          .then((response) => {
            this.webex.internal.metrics.submitClientMetrics(WDM_METRICS.JS_SDK_WDM_REGISTRATION_SUCCESSFULL);

            return this.processRegistrationSuccess(response);
          })
          .catch((error) => {
            this.webex.internal.metrics.submitClientMetrics(WDM_METRICS.JS_SDK_WDM_REGISTRATION_FAILED, {
              fields: {error}
            });
            throw error;
          });
