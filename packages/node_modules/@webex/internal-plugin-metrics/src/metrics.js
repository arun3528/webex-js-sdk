...
import BrowserDetection from '../../common/src/browser-detection';
...
const Metrics = WebexPlugin.extend({
  ...
  submitClientMetrics(eventName, props = {}, preLoginId) {
    ...
    payload.tags = {
      ...
      os: getOSName(),
      domain: window?.location.hostname || 'non-browser', // Check what else we could measure
    ...
    payload.fields = {
      ...
      platform: 'Web',
      spark_user_agent: getSparkUserAgent()
    };
